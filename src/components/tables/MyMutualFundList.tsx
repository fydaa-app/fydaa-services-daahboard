                ...
                {mutualfunds.map((mutualfund) => {
                  ...
                  return (
                    <TableRow key={mutualfund.id}>
                      ...
                      <TableCell className="px-4 py-3 text-gray-500 text-start text-theme-sm dark:text-gray-400">
                        {mutualfund.geography ? (
                          <Badge color="warning">
                            {mutualfund.geography === 'GreaterChina' ? 'Greater China'
                              : mutualfund.geography === 'MiddleEast' ? 'Middle East'
                                : mutualfund.geography === 'LatinAmerica' ? 'Latin America'
                                  : mutualfund.geography}
                          </Badge>
                        ) : (
