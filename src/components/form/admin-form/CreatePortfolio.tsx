        ...
        <form onSubmit={handleFormSubmit} className="p-4 space-y-4 max-h-[80vh] overflow-y-auto">
          ...
          {activeAllocationCategory && (
            <div className="fixed inset-0 bg-black/60 flex items-center justify-center p-4 z-[99999]">
              <div className="bg-white rounded-lg shadow-xl w-full max-w-4xl max-h-[90vh] flex flex-col dark:bg-gray-800">
                <div className="flex justify-between items-center p-4 border-b dark:border-gray-700">
                ...
                <div className="p-6 overflow-y-auto flex-1 space-y-4">
                  {fieldstock[activeAllocationCategory]?.map((field) => (
                    <div key={field.id} className="flex gap-2 items-center mb-1">
                      {renderDropdown(activeAllocationCategory, field)}                 
                      <Input
                ...
                <div className="flex justify-between items-center p-4 border-t dark:border-gray-700 bg-gray-50 dark:bg-gray-850">
