    ...
    <div className="fixed inset-0 bg-black-opacity flex items-center justify-center p-4 z-99999">
      <div className="bg-white rounded-lg shadow-xl w-full max-w-md dark:bg-gray-800">
        <div className="flex justify-between items-center p-4 border-b dark:border-gray-700">
          <h2 className="text-xl font-semibold dark:text-white">Edit US Stock</h2>
          <button
            onClick={closeModal}
        ...
        <form onSubmit={handleSubmit} className="p-4 space-y-4">
          ...
          <div>
            ...
            <Select
              ...
              options={[
                { value: "", label: stockData.StockType ? "Select Cap Type" : "Select Stock Type first" },
                ...(capTypeOptionsMap[stockData.StockType] || [])
              ]}
            />
          </div>
          ...
          <div className="flex justify-end gap-3 pt-4">
            ...
            >
              {isLoading
                ...
                : stockData.id ? 'Update US Stock' : 'Add US Stock'}
            </button>
          </div>
        </form>
      </div>
