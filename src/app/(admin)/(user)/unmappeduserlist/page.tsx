...
async function fetchUsers(
    ...
    try {
        let url = `${process.env.NEXT_PUBLIC_AUTH_URL}auth/getUnMappedUserList?page=${page}`;
    ...
    return (
        <div>
            ...
            <div className="space-y-6">
                <ComponentCard title="UnMapped User List">
                <div>
                    ...
                    <UserListTable users={users} error={error} currentPage={page} listType="Unmapped" searchQuery={searchQuery} />
                    {totalUsers > 0 && (
                        <Pagination 
                            currentPage={page} 
