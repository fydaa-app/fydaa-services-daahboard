...
interface Package {
  ...
  async function fetchPackages(searchQuery: string = ""): Promise<{ 
    packages: Package[]; 
    error: string | null;
    ...
    try {
      let url = `${process.env.NEXT_PUBLIC_STOCK_API_URL}${process.env.NEXT_PUBLIC_PACKAGES_ENDPOINT}`;
      ...
      return { packages: [], error: "Error fetching data" };
    }
  }
export default function PackageTablesPage() { 
    ...
    const fetchData = useCallback(async () => {
        try {
          const { packages, error} = await fetchPackages(searchQuery);
