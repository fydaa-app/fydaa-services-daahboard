...
import MyMutualFundListTable from "@/components/tables/MyMutualFundList"; 
import CreateMyMutualFund from "@/components/form/admin-form/CreateMyMutualFund";
...
async function fetchMutualFunds(
    ...
    try {
        let url = `${process.env.NEXT_PUBLIC_STOCK_API_URL}${process.env.NEXT_PUBLIC_MUTUAL_FUND_ENDPOINT || 'mutualFund'}?page=${page}&limit=${limit}`;
...
export default function MutualFundTablesPage() { 
    ...
    const fetchData = useCallback(async () => {
        try {
            ...
            const data = await fetchMutualFunds(pageNum, limit, searchQuery);
            setApiResponse(data);
    ...
    return (
        <div>
            <PageBreadcrumb pageTitle="Mutual Fund" />
            <div className="space-y-6">
                <ComponentCard title="Mutual Fund List">
